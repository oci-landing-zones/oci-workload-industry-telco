...
locals {
  ...
  custom_security_compartment_name  = var.sec_comp_name
  custom_network_compartment_name   = var.net_comp_name
  custom_appdev_compartment_name    = var.app_comp_name
  custom_database_compartment_name  = var.db_comp_name
...
locals {
  ...
  #-----------------------------------------------------------
  enclosing_compartment_key = "${var.enc_comp_name}"
  default_enclosing_compartment_name = var.enc_comp_name
  ...
  network_compartment_key  = "${var.net_comp_name}"
  default_network_compartment_name = var.net_comp_name
  ...
  security_compartment_key = "${var.sec_comp_name}"
  default_security_compartment_name = var.sec_comp_name
  ...
  appdev_compartment_key   = "${var.app_comp_name}"
  ...
  database_compartment_key = "${var.db_comp_name}"
